      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
          <li class="nav-item active" data-toggle="tooltip" data-placement="right" title="Dashboard">
            <a class="nav-link" href="{{ route('clientDorms.index') }}">
          ...
          <li class="nav-item" data-toggle="tooltip" data-placement="right" title="สถาณะหอพัก">
            ...
            <ul class="sidenav-second-level collapse" id="collapseComponents">
              <li>
                <a href="{{ route('clientRooms.index') }}">ดูห้องว่าง</a>
              </li>
              <li>
                <a href="{{ route('clientBills.index') }}">ดูห้องค้างชำระ</a>
              </li>
            </ul>
          </li>
          <li class="nav-item" data-toggle="tooltip" data-placement="right" title="รายละเอียด">
            ...
            <ul class="sidenav-second-level collapse" id="collapseExamplePages">
              <li>
                <a href="clientRules.html">รายละเอียดกฎ</a>
              </li>
              <li>
                <a href="{{ route('clientStaffs.index') }}">บุคลากร</a>
              </li>
              <li>
                <a href="#">สัญญาเช่า</a>
              </li>
